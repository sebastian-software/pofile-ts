...
| Format          | Intl API                  | Support                                                                                                              |
| --------------- | ------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| `{x, list}`     | `Intl.ListFormat`         | [CanIUse](https://caniuse.com/mdn-javascript_builtins_intl_listformat) — Chrome 72+, Firefox 78+, Safari 14.1+       |
| `{x, duration}` | `Intl.DurationFormat`     | [CanIUse](https://caniuse.com/mdn-javascript_builtins_intl_durationformat) — Chrome 129+, Firefox 131+ ⚠️            |
| `{x, ago}`      | `Intl.RelativeTimeFormat` | [CanIUse](https://caniuse.com/mdn-javascript_builtins_intl_relativetimeformat) — Chrome 71+, Firefox 65+, Safari 14+ |
| `{x, name}`     | `Intl.DisplayNames`       | [CanIUse](https://caniuse.com/mdn-javascript_builtins_intl_displaynames) — Chrome 81+, Firefox 86+, Safari 14.1+     |

<Callout type="warn">
  `Intl.DurationFormat` is a **Stage 3 proposal** and not yet widely supported. pofile-ts provides a
