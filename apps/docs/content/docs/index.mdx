...
- **Serialize PO Files** — Convert PO data back to strings, 2.5× faster than pofile, ~4.5× faster than gettext-parser
...
- **ICU Compiler** — Compile ICU to JavaScript functions, 3-4× faster at runtime
...
- **50+ Built-in Styles** — Common patterns like `compact`, `percent`, `bytes`, `iso`, `relative` ready to use
