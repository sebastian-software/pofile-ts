...
Get CLDR 48 plural categories and Gettext Plural-Forms headers for any locale. Validated against official CLDR test data — all major languages pass 100%.
...
getPluralSamples("ru")
// → { one: [1, 21, 31...], few: [2, 3, 4, 22...], many: [0, 5, 6...], other: [0.5, 1.5...] }
