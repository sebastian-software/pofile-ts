/**
 * SVG Icons
 * Most are from Lucide (https://lucide.dev/icons)
 */
...
// Lucide Icons for UseCase cards
...
export function CircleCheckIcon({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
// Feature card icons
export function SpeedIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function GlobeFeatureIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function CompileIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function ModernIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
